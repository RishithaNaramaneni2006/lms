...
<ul>
        ...
        <li style="float:right"><a href="/users">Users</a></li>
...
<table>
    ...
    <tbody>
        <tr th:each="user, status : ${users}">
            ...
            <td data-label="Mobile Number" th:text="${user.username}"></td>
            <td data-label="Email" th:text="${user.email}"></td>
            <td data-label="Due" th:text="${user.due}"></td>
            <td data-label="Address" th:text="${user.address}"></td>
        </tr>
    </tbody>
</table>
