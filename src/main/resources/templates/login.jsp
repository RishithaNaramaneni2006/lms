...
<style>
  ...
  --color-primary: rgb(76, 129, 241);
  --color-tertiary: rgb(76, 129, 241);
...
<body>
  ...
  <div class="form-inner">
    <h2 style="color: rgb(76, 129, 241);">Library Management System</h2>
    <div class="input-wrapper">
      <label for="login-username">Mobile Number</label>
    ...
    <div class="btn-group">
      ...
      </button><span style="font-size: calc(var(--font-size) / 1.5); margin-right: -45px;">Doesn't have an account? </span><a class="btn--text" href="/register">Create here</a>
